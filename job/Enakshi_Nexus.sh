#!/bin/bash
#SBATCH -J NEXT100_Single_eminus # A single job name for the array
#SBATCH -c 28 # Number of cores
#SBATCH -p shared # Partition
#SBATCH --mem 2000 # Memory request (6Gb)
#SBATCH -t 0-6:00 # Maximum execution time (D-HH:MM)
#SBATCH -o NEXT100_Single_eminus_%A_%a.out # Standard output
#SBATCH -e NEXT100_Single_eminus_%A_%a.err # Standard error
​
